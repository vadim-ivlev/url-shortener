...
func ShortenURLHandler(w http.ResponseWriter, r *http.Request) {
	...
	// memstore.Add(apptypes.URLShortener{OriginalURL: originalURL, UserID: userID})
	record, aNewOne, err := memstore.Add(apptypes.URLShortener{OriginalURL: originalURL, UserID: userID})
...
func RedirectHandler(w http.ResponseWriter, r *http.Request) {
	...
	record, err := memstore.GetByShortID(id)
...
func APIShortenBatchHandler(w http.ResponseWriter, r *http.Request) {
	...
	for _, r := range inputRecords {
		...
		record, _, err := memstore.Add(apptypes.URLShortener{OriginalURL: originalURL, UserID: userID})
...
func APIUserURLsHandler(w http.ResponseWriter, r *http.Request) {
	...
	records := memstore.GetByUserID(userID)
...
func deleteShortIDs(ctx context.Context, userID string, ids []any) (err error) {
	memstore.DeleteShortIDs(userID, ids)
